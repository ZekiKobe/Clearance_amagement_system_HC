<?php
 ...
 if(!isset($_SESSION['sport_logged_in'])){
...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Sport</title>
     <link rel="stylesheet" href="css/sportdep/sport_home_page.css">
     <link rel="stylesheet" href="css/sportdep/sportSmallScreen.css">
  ...
  <body>
               ...
               <li>
                <span class="icon"> <img src="icons/manage(copy).png" width="20px" height="20px" alt=""> </span>
                 ...
                 <div class="dropdown-container" id="dropdown-cont" style="flex-direction:column;">
                    <a href="#material-register">Record Material</a>
      ...
      <div class="main-home">
        <div class="top-container">
            ...
            <div class="top-title" style="display: flex; flex-direction: column; align-items:center; justify-content:center;">
                ...
                <p>Students online clearance system - Sport Department</p>
            </div>
            <div class="profile-cont">
            <img src="<?php echo $_SESSION['sport_image']; ?>" alt="" width="60px" height="60px">
                <div class="dropdown">
                  <button onclick="myFunction()" class="dropbtn"><?php echo $_SESSION ['sport_u_name'];?>&#9660;</button>
        ...
        <div class="main-main-home">
          <a name="dashboard">
           <div class="dashboard-container">
              <div class="dashboard">
                <img src="icons/pen.png" width="30px" height="30px" alt="">
                <h4>Total Property lend Students</h4>
                <?php
                  $stmt="SELECT material_id FROM sport_record ORDER BY student_id";
              ...
              <div class="dashboard">
                ...
                <?php
                  $stmt="SELECT id FROM request_sport ORDER BY id";
                  $res=mysqli_query($conn,$stmt) or die(mysqli_error($conn));
                  $row=mysqli_num_rows($res);
                  ?>
                  <p><?php echo $row ?></p>
              ...
              <div class="dashboard">
                ...
                <h4>Total approved request</h4>
                <?php
                  $stmt="SELECT student_id FROM sport_final_approve_reject ORDER BY student_id";
                  $res=mysqli_query($conn,$stmt) or die(mysqli_error($conn));
                  $row=mysqli_num_rows($res);
                  ?>
                  <p> <?php echo $row; ?> </p>
              ...
              <div class="dashboard">
                ...
                <?php
                  $stmt="SELECT student_id FROM sport_rejected_requests ORDER BY student_id";
                  $res=mysqli_query($conn,$stmt) or die(mysqli_error($conn));
                  $row=mysqli_num_rows($res);
                  ?>
                  <p> <?php echo $row; ?> </p>
           ...
           <div class="view-request-container">
             ...
             <?php
              $sql="SELECT * FROM request_sport INNER JOIN student ON request_sport.id = student.id";
              ...
              <div class="requests">
                ...
                <button>
                  <a href="sport_approval.php?manageid=<?php echo $student_id; ?>&fullName=<?php echo $fullName; ?>&reason=<?php echo $reason; ?>">Manage</a>
                </button>
             </div>
             <hr>
             <?php
           ...
           <div class="material-lend-register">
               <div class="top-title" style="background-color: rgb(35, 50, 51);">
                 <h1 style="text-align: center;">Register Material Lend</h1>
               </div>
               <form class="registe-material" method="post" enctype="multipart/form-data">
                 ...
                 <div class="form-row">
                   ...
                   <input type="text" name="given_by" value="<?php echo $_SESSION['sport_full_name']; ?>" required>
                 </div>
                 ...
                 <?php
                     if(isset($_POST["register"]))
                     {
                       ...
                       $given_by=$_POST["given_by"];
                               $sql2=mysqli_query($conn,"INSERT INTO sport_record(material_id,material_name, date_taken, taken_by,student_id,given_by)
           ...
           <a name="edit-delete-lend">
            <div class="edit-delete-material-lend-container">
             <div class="top-h1-add-container">
               <h3 style="margin: 10px; background-color:orangered; color:white; padding:5px;">List of materials lend </h3>
             </div>
                <div class="table-of-record-container">
                  ...
                  <th>Material ID</th>
                   ...
                   <?php
                            ...
                            $query=mysqli_query($conn,"SELECT * FROM sport_record WHERE CONCAT(material_name,student_id,taken_by) LIKE '%$filterValues%'") or die(mysqli_error($conn));
                            ...
                            if($rows_srch>0){
                              while ($rows_srch=mysqli_fetch_assoc($query)){
                                ...
                                $table_name="sport_record";
                                $header="sport.php#edit-delete-lend";
                                ?>
                                <tr>
                   ...
                   <td><?php echo $m_id; ?></td>
                    ...
                    <td>
                      ...
                      <a href="delete_record.php?deleteid=<?php echo $m_id; ?>&tn=<?php echo $table_name; ?>&sti=<?php echo $student_id; ?>&hdr=<?php echo $header; ?>">
                        <button style="background-color: red;">&times; delete</button></a>
                      </div>
                    </td>
                   </tr>
                   <?php
    ...
    <div class="popup-profile-container" id="popup-profile">
      ...
      <div class="profile-detail">
        ...
        <p id="firstnm"><?php echo $_SESSION['sport_full_name']; ?></p>
        </div>
        <hr>
        <div class="detail">
          <label for="dept">ID :</label>
          <p id="dept"><?php echo $_SESSION['sport_id']; ?></p>
        </div>
        <hr>
        <div class="detail">
          <label for="age">Age :</label>
          <p id="age"><?php echo $_SESSION['sport_ag']; ?></p>
        </div>
        <hr>
        <div class="detail">
          <label for="sex">Sex :</label>
          <p id="sex"><?php echo $_SESSION['sport_sx']; ?></p>
        </div>
        <hr>
        <div class="detail">
          <label for="year">Qualification :</label>
          <p id="year"><?php echo $_SESSION['sport_qualification']; ?></p>
        </div>
        <hr>
         <div class="detail">
          <label for="academic">Position :</label>
          <p id="academic"><?php echo $_SESSION['sport_position']; ?></p>
         </div>
      </div>
      <div class="profile-picture-container">
          <div class="profile-picture-bg">
          <?php
             $sql="SELECT * FROM staff WHERE username='".$_SESSION['sport_u_name']."' ";
              $res=mysqli_query($conn,$sql) or die( mysqli_error($conn));
              $rows=mysqli_num_rows($res);
              if($rows>0){
                while ($rows=mysqli_fetch_assoc($res)){
           ...
           <div class="changepw-buttons">
              ...
              <?php
                  if(isset($_POST["change_pw"])){
                    ...
                    $sql_change_password=mysqli_query($conn,"SELECT * FROM login WHERE username='".$_SESSION['sport_u_name']."'") or die(mysqli_error($conn));
                    ...
                    while ($rows=mysqli_fetch_assoc($sql_change_password)){
                        ...
                        if($new_password==$confirm_password && $old_password == $old_pw){
                          $sql_change=mysqli_query($conn,"UPDATE login SET password='$new_password' WHERE username='".$_SESSION['sport_u_name']."' ") or die(mysqli_error($conn));
